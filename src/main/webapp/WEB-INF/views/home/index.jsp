...
<body>
  ...
  <ul>
    <c:forEach items="${bingoRoomList}" var="bingoRoom">
      <li><a
        href="${pageContext.request.contextPath}/host/bingoRoom/${bingoRoom.bingoRoomId}/edit">${f:h(bingoRoom.roomName)}</a>
        <c:if test="${!bingoRoom.started}">
          <form:form
            action="${pageContext.request.contextPath}/host/bingoRoom/${bingoRoom.bingoRoomId}/start"
          ...
          action="${pageContext.request.contextPath}/host/bingoRoom/${bingoRoom.bingoRoomId}/delete"
          method="POST" modelAttribute="bingoRoomForm">
